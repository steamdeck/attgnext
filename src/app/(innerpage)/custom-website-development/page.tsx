...
import content from '@/content/servicePages/custom-website-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/custom-website-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/custom-website-development` },
  };
}
