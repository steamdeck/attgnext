...
import content from '@/content/servicePages/multi-vendor-website-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/multi-vendor-website-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/multi-vendor-website-development` },
  };
}
