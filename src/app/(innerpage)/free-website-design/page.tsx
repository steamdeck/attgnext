...
import content from '@/content/servicePages/free-website-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/free-website-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/free-website-design` },
  };
}
