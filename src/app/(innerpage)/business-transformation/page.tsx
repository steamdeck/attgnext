    ...
    return (
        <>
            <SEOHead 
                ...
                defaultTitle="Business Transformation Services | AT Tech Global"
                defaultDescription="Transform your business with our expert digital transformation services. We help companies modernize operations, adopt new technologies, and drive sustainable growth."
                defaultKeywords="business transformation, digital transformation, business consulting, process automation, technology adoption, digital strategy"
            />
