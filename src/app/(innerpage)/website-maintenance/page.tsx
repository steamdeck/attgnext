...
import content from '@/content/servicePages/website-maintenance';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/website-maintenance');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/website-maintenance` },
  };
}
