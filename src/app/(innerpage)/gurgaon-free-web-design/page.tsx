...
import content from '@/content/servicePages/gurgaon-free-web-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/gurgaon-free-web-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/gurgaon-free-web-design` },
  };
}
