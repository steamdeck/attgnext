...
import content from '@/content/servicePages/corporate-website-design-service';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/corporate-website-design-service` },
  };
}
