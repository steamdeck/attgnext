...
import content from '@/content/servicePages/mobile-friendly-website';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/mobile-friendly-website');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/mobile-friendly-website` },
  };
}
