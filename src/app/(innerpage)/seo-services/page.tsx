...
import content from '@/content/servicePages/seo-services';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/seo-services');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/seo-services` },
  };
}
