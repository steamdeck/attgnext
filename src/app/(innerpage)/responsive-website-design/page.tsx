...
import content from '@/content/servicePages/responsive-website-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/responsive-website-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/responsive-website-design` },
  };
}
