...
import content from '@/content/servicePages/static-website-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/static-website-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/static-website-design` },
  };
}
