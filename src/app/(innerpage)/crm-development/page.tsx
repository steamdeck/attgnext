...
import content from '@/content/servicePages/crm-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/crm-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/crm-development` },
  };
}
