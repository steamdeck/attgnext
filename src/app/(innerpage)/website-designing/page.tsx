...
import content from '@/content/servicePages/website-designing';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/website-designing');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/website-designing` },
  };
}
