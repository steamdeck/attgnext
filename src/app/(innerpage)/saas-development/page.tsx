...
import content from '@/content/servicePages/saas-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/saas-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/saas-development` },
  };
}
