...
import content from '@/content/servicePages/business-profile-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/business-profile-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/business-profile-design` },
  };
}
