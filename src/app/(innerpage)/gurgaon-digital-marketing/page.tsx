...
import content from '@/content/servicePages/gurgaon-digital-marketing';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/gurgaon-digital-marketing');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/gurgaon-digital-marketing` },
  };
}
