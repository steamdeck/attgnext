...
import content from '@/content/servicePages/responsive-website-design-gurgaon';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/responsive-website-design-gurgaon');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/responsive-website-design-gurgaon` },
  };
}
