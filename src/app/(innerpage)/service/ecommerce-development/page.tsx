...
import content from '@/content/servicePages/ecommerce-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/service/ecommerce-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/service/ecommerce-development` },
  };
}
