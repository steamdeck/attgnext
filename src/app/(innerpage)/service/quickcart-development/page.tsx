...
import content from '@/content/servicePages/quickcart-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/service/quickcart-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/service/quickcart-development` },
  };
}
