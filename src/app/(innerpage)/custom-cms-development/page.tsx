...
import content from '@/content/servicePages/custom-cms-development';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/custom-cms-development');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/custom-cms-development` },
  };
}
