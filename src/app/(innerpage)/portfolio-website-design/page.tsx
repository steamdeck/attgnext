...
import content from '@/content/servicePages/portfolio-website-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/portfolio-website-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/portfolio-website-design` },
  };
}
