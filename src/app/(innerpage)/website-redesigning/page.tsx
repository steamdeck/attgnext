...
import content from '@/content/servicePages/website-redesigning';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/website-redesigning');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/website-redesigning` },
  };
}
