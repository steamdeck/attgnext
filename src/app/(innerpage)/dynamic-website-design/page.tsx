...
import content from '@/content/servicePages/dynamic-website-design';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/dynamic-website-design');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/dynamic-website-design` },
  };
}
