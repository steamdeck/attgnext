...
import content from '@/content/servicePages/performance-optimization';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/performance-optimization');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/performance-optimization` },
  };
}
