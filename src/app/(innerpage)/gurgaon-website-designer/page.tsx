...
import content from '@/content/servicePages/gurgaon-website-designer';

export async function generateMetadata(): Promise<Metadata> {
  const metadata = await getMetadata('/gurgaon-website-designer');
  if (metadata) {
  ...
  return {
    ...
    keywords: content.seo.keywords
      ...
      .filter(Boolean),
    alternates: { canonical: `https://www.attechglobal.com/gurgaon-website-designer` },
  };
}
