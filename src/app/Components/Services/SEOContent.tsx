      ...
      <section className="cs_gray_bg_2">
        ...
        <div className="container">
          <div className="cs_section_heading cs_style_1 text-center">
            ...
            <h2 className="cs_fs_48 mb-0">Choose Your SEO Package</h2>
          </div>
          <div className="cs_height_60 cs_height_lg_50"></div>
          <div className="row cs_row_gap_30 cs_gap_y_30">
            <div className="col-lg-4 col-md-6">
              <div className="cs_pricing_card cs_style_1 cs_radius_20 text-center">
                <div className="cs_pricing_header cs_mb_30">
                  <h3 className="cs_pricing_title cs_fs_24 cs_semibold cs_mb_10">Local SEO</h3>
                  <div className="cs_pricing_price cs_fs_48 cs_fw_bold cs_accent_color">$999</div>
                  <p className="cs_pricing_subtitle">Perfect for local businesses</p>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="cs_pricing_card cs_style_1 cs_radius_20 text-center cs_popular">
                ...
                <div className="cs_pricing_header cs_mb_30">
                  <h3 className="cs_pricing_title cs_fs_24 cs_semibold cs_mb_10">Business SEO</h3>
                ...
                <div className="cs_pricing_features cs_mb_30">
                  <ul className="cs_pricing_list">
                    ...
                    <li>Link building (5 links/month)</li>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="cs_pricing_card cs_style_1 cs_radius_20 text-center">
                <div className="cs_pricing_header cs_mb_30">
                  <h3 className="cs_pricing_title cs_fs_24 cs_semibold cs_mb_10">Enterprise SEO</h3>
                  <div className="cs_pricing_price cs_fs_48 cs_fw_bold cs_accent_color">$3,999</div>
                  <p className="cs_pricing_subtitle">For large businesses and e-commerce</p>
                </div>
                <div className="cs_pricing_features cs_mb_30">
                  <ul className="cs_pricing_list">
                    ...
                    <li>Link building (15 links/month)</li>
