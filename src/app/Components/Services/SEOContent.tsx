    ...
    <div>
            ...
            <div className="col-lg-6">
              <div className="cs_section_heading cs_style_1">
                ...
                <p className="cs_fs_18 cs_mb_30">
                  At AT Tech Global, we specialize in white-hat SEO techniques that improve your search rankings 
          ...
          <div className="row cs_row_gap_30 cs_gap_y_40">
            <div className="col-lg-6">
              <div className="cs_case_study cs_radius_20 cs_p_40" style={{ 
                ...
                <h3 className="cs_case_title cs_fs_24 cs_semibold cs_mb_15" style={{ color: '#ffffff' }}>Local Law Firm SEO</h3>
                <p className="cs_case_challenge cs_mb_20" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Challenge:</strong> A local law firm was struggling to rank for competitive legal keywords and attract clients online.
                </p>
                <p className="cs_case_solution cs_mb_20" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Solution:</strong> We implemented a comprehensive local SEO strategy including Google My Business optimization, local citations, and content marketing.
                </p>
                ...
                <div className="cs_case_timeline cs_mt_20" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Timeline:</strong> 8 months
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="cs_case_study cs_radius_20 cs_p_40" style={{ 
                ...
                <h3 className="cs_case_title cs_fs_24 cs_semibold cs_mb_15" style={{ color: '#ffffff' }}>E-commerce Store SEO</h3>
                <p className="cs_case_challenge cs_mb_20" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Challenge:</strong> An online retailer needed to improve product visibility and compete with larger e-commerce sites.
                </p>
                <p className="cs_case_solution cs_mb_20" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Solution:</strong> We focused on e-commerce SEO including product page optimization, category structure, and technical SEO improvements.
                </p>
                <div className="cs_case_results" style={{ color: '#f0f0f0' }}>
                  <strong style={{ color: '#ffffff' }}>Results:</strong>
                  <ul className="cs_mt_10" style={{ color: '#f0f0f0' }}>
      ...
      <section>
        ...
        <div className="container">
          <div className="cs_section_heading cs_style_1 text-center">
            <p className="cs_section_subtitle cs_center cs_fs-18 cs_semibold cs_accent_color cs_mb_20">
              <span className="cs_shape_right"></span>Related Services<span className="cs_shape_right"></span>
            </p>
            <h2 className="cs_fs_48 mb-0">Complement Your SEO Strategy</h2>
            <p className="cs_section_heading_text mt-3 mb-0">
              Combine SEO with other digital marketing services for maximum impact
            </p>
          </div>
          <div className="cs_height_60 cs_height_lg_50"></div>
          <div className="row cs_row_gap_30 cs_gap_y_30">
            <div className="col-lg-4 col-md-6">
              <div className="cs_card cs_style_2 cs_radius_10 position-relative overflow-hidden">
                ...
                <div className="cs_card_content">
                  ...
                  <p className="cs_card_subtitle cs_mb_22">
                    Get immediate results while SEO builds long-term rankings. PPC complements SEO perfectly.
                  </p>
                  <Link href="/service/ppc" className="cs_card_btn cs_center cs_radius_50">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="cs_card cs_style_2 cs_radius_10 position-relative overflow-hidden">
                <span className="cs_card_icon cs_white_bg cs_center cs_radius_50 cs_mb_25">
                  <Image src="/assets/img/icons/social.svg" alt="Social Media Marketing" width={35} height={40} />
                </span>
                <div className="cs_card_content">
                  <h3 className="cs_card_title cs_fs_22 cs_semibold cs_mb_10">
                  ...
                  <p className="cs_card_subtitle cs_mb_22">
                    Boost your brand visibility and drive traffic through strategic social media campaigns.
                  </p>
                  <Link href="/service/smm" className="cs_card_btn cs_center cs_radius_50">
                    <Image src="/assets/img/icons/arrow_right.svg" alt="img" width={23} height={23} />
                  </Link>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="cs_card cs_style_2 cs_radius_10 position-relative overflow-hidden">
                <span className="cs_card_icon cs_white_bg cs_center cs_radius_50 cs_mb_25">
                  <Image src="/assets/img/icons/ux-ui.svg" alt="Web Development" width={35} height={40} />
                </span>
                <div className="cs_card_content">
                  <h3 className="cs_card_title cs_fs_22 cs_semibold cs_mb_10">
                  ...
                  <p className="cs_card_subtitle cs_mb_22">
                    Ensure your website is technically sound and optimized for both users and search engines.
                  </p>
                  <Link href="/service/web-development" className="cs_card_btn cs_center cs_radius_50">
                    <Image src="/assets/img/icons/arrow_right.svg" alt="img" width={23} height={23} />
                  </Link>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              ...
              <p className="cs_fs_14 cs_white_color">
                Learn more about our <Link href="/service/digital-marketing" className="cs_white_color" style={{textDecoration: 'underline'}}>digital marketing services</Link> or check our <Link href="/faq" className="cs_white_color" style={{textDecoration: 'underline'}}>FAQ page</Link> for common questions.
              </p>
            </div>
          </div>
        </div>
