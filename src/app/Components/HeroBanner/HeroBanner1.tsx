...
const HeroBanner1 = () => {
    ...
    return (
        <section className="cs_hero cs_style_1 cs_bg_filled position-relative" style={{backgroundImage: "url('/assets/img/hero_bg_1.jpg')"}}>
        <div className="container">
          <div className="cs_hero_content">
            <div className="cs_hero_thumbnail wow fadeInLeft">
              <Image src="/assets/img/d835b88d-c208-413d-86bb-e01acd825149.jpg" alt="img" width={916} height={473} priority />
            ...
            <div className="cs_top_content">
              <div className="cs_clients_info">
                <a onClick={handelClick} aria-label="Play video button" className="cs_video cs_style_1 cs_video_open cs_center cs_radius_50 cs_mb_20 wow zoomIn">
                  <Image src="https://www.freeiconspng.com/uploads/video-player-icon-15.png" alt="img" className="cs_video_bg" width={120} height={120} loading="lazy" />
                ...
                <Image src="https://www.appsflyer.com/wp-content/uploads/2021/08/Active-users.jpg" alt="img" width={176} height={40} loading="lazy" />
              </div>
            </div>
