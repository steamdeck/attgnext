...
const Blog4 = () => {
    ...
    const chooseContent = [
        ...
        {img:'/assets/img/post_9.jpg', title:'Supervisor Disapproved of Latest Work.', content:'Security', link:'/blog/blog-details', date:'12'},
        {img:'/assets/img/post_10.jpg', title:'Unlocking Potential Through Technology', content:'Security', link:'/blog/blog-details', date:'11'},
        {img:'/assets/img/post_11.jpg', title:'Simplify Streamline Succeed IT Solutions', content:'Security', link:'/blog/blog-details', date:'10'},
      ]; 
        ...
        {chooseContent.map((item, i) => (
          <div key={i} className="col-lg-4 wow fadeInLeft">
            <article className="cs_post cs_style_1 cs_type_1">
              <Link href={item.link || '/blog/blog-details'} aria-label="Click to read post" className="cs_post_thumbnail position-relative">
              <Image src={item.img} alt={item.title} width={362} height={235}   />
              <span className="cs_posted_by cs_blue_bg cs_white_color cs_radius_10 text-center position-absolute">
              <span className="cs_fs_24 cs_bold">{item.date || '17'}</span>
              <span className="cs_fs_12">Jan</span>
              </span>
              </Link>
              <div className="cs_post_content cs_white_bg">
                ...
                <h3 className="cs_post_title cs_fs_22 cs_mb_11">
                  <Link href={item.link || '/blog/blog-details'} aria-label="Click to read post">{item.title}</Link>
                </h3>
                <Link href={item.link || '/blog/blog-details'} aria-label="Click to read post" className="cs_post_btn cs_medium">
                  <span>Read More</span>
                  <span>
