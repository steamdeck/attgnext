...
const Team3 = () => {
  ...
  const teamContent = [
    { img: '/assets/img/team_5.jpg', name: 'Alex Thomas', content: 'Founder & Director', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
    ...
    { img: '/assets/img/team_9.jpg', name: 'Alex Thomas', content: 'Digital Marketing Head', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
