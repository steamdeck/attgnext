...
const Video1 = () => {
    ...
    return (
        ...
        <div className="container-fluid">
          <div className="cs_video_block cs_style_1 cs_center cs_bg_filed position-relative wow fadeInDown" data-background="/assets/img/ce235bcb-7122-4be6-ae71-65eeedde9c1d.jpg">
