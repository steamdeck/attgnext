...
function AdminLogin() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authenticateAdmin"])(credentials);
            if (result) {
...
_s(AdminLogin, "yZfiaBfOQgjYopMqPatxIgOvxps=", false, function() {
    return [
